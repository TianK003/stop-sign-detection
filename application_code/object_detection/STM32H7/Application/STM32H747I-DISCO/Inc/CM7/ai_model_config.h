...
#define POSTPROCESS_TYPE    POSTPROCESS_YOLO_V2


/* Postprocessing TINY_YOLO_V2 configuration */
#define AI_OBJDETECT_YOLOV2_PP_NB_CLASSES      (1)
#define AI_OBJDETECT_YOLOV2_PP_GRID_WIDTH      (16)
#define AI_OBJDETECT_YOLOV2_PP_GRID_HEIGHT     (16)
...
static const float32_t AI_OBJDETECT_YOLOV2_PP_ANCHORS[2*AI_OBJDETECT_YOLOV2_PP_NB_ANCHORS] ={0.076023, 0.258508, 0.163031, 0.413531, 0.234769, 0.702585, 0.427054, 0.715892, 0.748154, 0.857092};
#define AI_OBJDETECT_YOLOV2_PP_IOU_THRESHOLD      (0.5)
#define AI_OBJDETECT_YOLOV2_PP_CONF_THRESHOLD     (0.5)
