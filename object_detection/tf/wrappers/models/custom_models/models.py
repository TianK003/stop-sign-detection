...
TF_MODEL_FNS = {
    'st_yololcv1': (get_st_yololcv1, {}),
    'st_yoloxn_d033_w025': (get_st_yoloxn, {'depth_mul': 0.33, 'width_mul': 0.25}),
    'st_yoloxn_d100_w025': (get_st_yoloxn, {'depth_mul': 1, 'width_mul': 0.25}),
    'st_yoloxn_d050_w040': (get_st_yoloxn, {'depth_mul': 0.5, 'width_mul': 0.4}),
    'st_yoloxn': (get_st_yoloxn, {}),}
