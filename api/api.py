...
# Required: tensorflow object detection ---------------------------------------
# These imports MUST succeed — they register the OD wrappers used by every run.
...
# Optional: every other vertical ----------------------------------------------
# Each non-object-detection-TF vertical is loaded lazily via importlib so that
# missing directories (thinned-down checkout) or missing optional deps (e.g.
# pesq on Windows for speech_enhancement) don't break the OD pipeline. One
# summary log line per skipped vertical.
import importlib as _importlib

def _import_optional(*module_paths):
    skipped = {}
    for path in module_paths:
        try:
            _importlib.import_module(path)
        except ImportError as e:
            top = path.split('.', 1)[0]
            skipped.setdefault(top, str(e))
    for top, msg in skipped.items():
        LOGGER.info(f"[api.api] optional vertical '{top}' not loaded ({msg})")

_import_optional(
    # image classification (TF + PyTorch)
    "image_classification.tf.wrappers.datasets",
    "image_classification.tf.wrappers.models",
    "image_classification.tf.wrappers.training",
    "image_classification.tf.wrappers.quantization",
    "image_classification.tf.wrappers.evaluation",
    "image_classification.tf.wrappers.prediction",
    "image_classification.pt.wrappers.datasets",
    "image_classification.pt.wrappers.models",
    "image_classification.pt.wrappers.training",
    "image_classification.pt.wrappers.quantization",
    "image_classification.pt.wrappers.evaluation",
    "image_classification.pt.wrappers.prediction",
    # audio event detection
    "audio_event_detection.tf.wrappers.models.standard_models",
    "audio_event_detection.tf.wrappers.datasets",
    "audio_event_detection.tf.wrappers.training",
    "audio_event_detection.tf.wrappers.evaluation",
    "audio_event_detection.tf.wrappers.quantization",
    "audio_event_detection.tf.wrappers.prediction",
    # depth estimation
    "depth_estimation.tf.wrappers.datasets",
    "depth_estimation.tf.wrappers.prediction",
    # instance segmentation
    "instance_segmentation.tf.wrappers.datasets",
    "instance_segmentation.tf.wrappers.prediction",
    # object detection (PyTorch — TF tree above is mandatory)
    "object_detection.pt.wrappers.models",
    "object_detection.pt.wrappers.datasets",
    "object_detection.pt.wrappers.training",
    "object_detection.pt.wrappers.evaluation",
    "object_detection.pt.wrappers.prediction",
    # pose estimation
    "pose_estimation.tf.wrappers.datasets",
    "pose_estimation.tf.wrappers.models.custom_models",
    "pose_estimation.tf.wrappers.training",
    "pose_estimation.tf.wrappers.evaluation",
    "pose_estimation.tf.wrappers.quantization",
    "pose_estimation.tf.wrappers.prediction",
    # neural style transfer
    "neural_style_transfer.tf.wrappers.datasets",
    "neural_style_transfer.tf.wrappers.prediction",
    # re-identification
    "re_identification.tf.wrappers.models.standard_models",
    # semantic segmentation
    "semantic_segmentation.tf.wrappers.models",
    "semantic_segmentation.tf.wrappers.datasets",
    "semantic_segmentation.tf.wrappers.training",
    "semantic_segmentation.tf.wrappers.evaluation",
    "semantic_segmentation.tf.wrappers.prediction",
    "semantic_segmentation.tf.wrappers.quantization",
    # arc fault detection
    "arc_fault_detection.tf.wrappers.models.custom_models",
    "arc_fault_detection.tf.wrappers.datasets",
    "arc_fault_detection.tf.wrappers.quantization",
    "arc_fault_detection.tf.wrappers.training",
    "arc_fault_detection.tf.wrappers.evaluation",
    "arc_fault_detection.tf.wrappers.prediction",
    # speech enhancement (also needs pesq, no Windows wheel)
    "speech_enhancement.pt.wrappers.models.custom_models",
    "speech_enhancement.pt.wrappers.datasets",
    "speech_enhancement.pt.wrappers.evaluation",
    "speech_enhancement.pt.wrappers.quantization",
    "speech_enhancement.pt.wrappers.training",
    # human activity recognition
    "human_activity_recognition.tf.wrappers.models.custom_models",
    "human_activity_recognition.tf.wrappers.datasets",
    "human_activity_recognition.tf.wrappers.training",
    "human_activity_recognition.tf.wrappers.evaluation",
    # hand posture
    "hand_posture.tf.wrappers.models.custom_models",
    "hand_posture.tf.wrappers.datasets",
    "hand_posture.tf.wrappers.training",
    "hand_posture.tf.wrappers.evaluation",
)
